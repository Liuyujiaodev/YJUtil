...
- (UIImage *)imagesNamedFromCustomBundle:(NSString *)imgName
{
    ...
    NSString *bundlePath = [[NSBundle mainBundle].resourcePath stringByAppendingPathComponent:@"ImageAssets.bundle"];
...
- (void)callBackWithButton:(UIButton *)btnSender
{
    if (self.delegate && [self.delegate respondsToSelector:@selector(alertView:clickedButtonAtIndex:)]) {
        [self.delegate alertView:self clickedButtonAtIndex:btnSender.tag - 1000];
    }
